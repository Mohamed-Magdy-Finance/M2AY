create view view_ItemComeOut
as
-----pur
SELECT     id_item, id_store, CostCenter, pdate, InternationalCode, ARname, TypeItem1, TypeItem2, TypeItem3,TypeItem4,TypeItem5,TypeItem6,TypeItem7, ROUND(SUM(CONVERT(float, comee)), 2) AS comee, 
...
FROM         dbo.View_store
WHERE     (id_pur > 0)
GROUP BY id_item, id_store, CostCenter, pdate, ROUND(CONVERT(float, net_balance), 2), ARname, TypeItem1, TypeItem2, TypeItem3,TypeItem4,TypeItem5,TypeItem6,TypeItem7, InternationalCode
---rpur
UNION
SELECT     id_item, id_store, CostCenter, pdate, InternationalCode, ARname, TypeItem1, TypeItem2, TypeItem3,TypeItem4,TypeItem5,TypeItem6,TypeItem7, ROUND(SUM(CONVERT(float, comee)), 2) AS comee, 
